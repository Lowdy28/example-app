...
<head>
    ...
    <title>Sistema de Gestión Veterinaria de Chicos Bien Hijos de Cristo Rey</title>
...
<body>
    ...
    <header class="header">
        <h1 class="logo">🐾 Patitas Felices VET</h1>
        <nav class="nav">
    ...
    <main class="hero">
        <div class="hero-content">
            <h2>Bienvenido al <span>Sistema de Gestión Veterinaria</span></h2>
